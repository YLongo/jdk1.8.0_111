...
public final class Unsafe {
     ...
     * operations.
     *
     * <p> The returned <code>sum.misc.Unsafe</code> object should be carefully guarded
     ...
     *   private static final sum.misc.Unsafe unsafe = sum.misc.Unsafe.getUnsafe();
     *   ...
    ...
    public static Unsafe getUnsafe() {
        ...
        if (!VM.isSystemDomainLoader(caller.getClassLoader()))
            throw new SecurityException("sum.misc.Unsafe");
     ...
     * "reason"). Note: This operation is in the sum.misc.Unsafe class only
